   // Copyright 2010 Christoph Gärtner
    ...
    extern size_t dom_getElementsByTagName(
     ...
     extern int dom_hasChildNodes(dom_node_t node);
     
     extern size_t dom_childNodes(dom_node_t node, size_t max_nodes, dom_node_t *nodes);
     
     extern const char *dom_getAttribute(dom_node_t node, const char *name);
